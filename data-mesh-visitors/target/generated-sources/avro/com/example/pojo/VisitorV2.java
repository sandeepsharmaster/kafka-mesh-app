...
public class VisitorV2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static BinaryMessageEncoder<VisitorV2> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<VisitorV2> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<VisitorV2> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this VisitorV2 to a ByteBuffer.
  ...
  /**
   * Deserializes a VisitorV2 from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a VisitorV2 instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static VisitorV2 fromByteBuffer(
   ...
   */
  public VisitorV2(java.lang.String first_name, java.lang.String last_name, java.lang.Integer age, java.lang.Float height, java.lang.Float weight, java.lang.String phone_number, java.lang.String email) {
  ...
  /**
   * Creates a new VisitorV2 RecordBuilder.
   * @return A new VisitorV2 RecordBuilder
   */
  public static com.example.pojo.VisitorV2.Builder newBuilder() {
    return new com.example.pojo.VisitorV2.Builder();
  }

  /**
   * Creates a new VisitorV2 RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new VisitorV2 RecordBuilder
   */
  public static com.example.pojo.VisitorV2.Builder newBuilder(com.example.pojo.VisitorV2.Builder other) {
    if (other == null) {
      return new com.example.pojo.VisitorV2.Builder();
    } else {
      return new com.example.pojo.VisitorV2.Builder(other);
    }
  }

  /**
   * Creates a new VisitorV2 RecordBuilder by copying an existing VisitorV2 instance.
   * @param other The existing instance to copy.
   * @return A new VisitorV2 RecordBuilder
   */
  public static com.example.pojo.VisitorV2.Builder newBuilder(com.example.pojo.VisitorV2 other) {
    if (other == null) {
      return new com.example.pojo.VisitorV2.Builder();
    } else {
      return new com.example.pojo.VisitorV2.Builder(other);
  ...
  /**
   * RecordBuilder for VisitorV2 instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<VisitorV2>
    implements org.apache.avro.data.RecordBuilder<VisitorV2> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.pojo.VisitorV2.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing VisitorV2 instance
     * @param other The existing instance to copy.
     */
    private Builder(com.example.pojo.VisitorV2 other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.first_name)) {
        this.first_name = data().deepCopy(fields()[0].schema(), other.first_name);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder clearFirstName() {
      first_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder clearLastName() {
      last_name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder setHeight(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder clearHeight() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder setWeight(float value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder clearWeight() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder setPhoneNumber(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder clearPhoneNumber() {
      phone_number = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder setEmail(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.pojo.VisitorV2.Builder clearEmail() {
      email = null;
    ...
    public VisitorV2 build() {
      try {
        VisitorV2 record = new VisitorV2();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<VisitorV2>
    WRITER$ = (org.apache.avro.io.DatumWriter<VisitorV2>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<VisitorV2>
    READER$ = (org.apache.avro.io.DatumReader<VisitorV2>)MODEL$.createDatumReader(SCHEMA$);
